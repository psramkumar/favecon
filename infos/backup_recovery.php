<?php
	...
	//Hole infos
	$text="echo \"".$lang['infos']['backup_recovery'][$info]['text']."\";";
?>
...
<html>
	<head>
    	...
    	<title><?=$lang['infos']['backup_recovery'][$info]['header']?> - <?=$user->settings['favecon_title']?></title>
        <style type="text/css">
			body, body * {
    ...
    <body>
		<h1><?=$lang['infos']['backup_recovery'][$info]['header']?></h1><br>
        <?=eval($text)?><br><br>
        <div align='center'>
