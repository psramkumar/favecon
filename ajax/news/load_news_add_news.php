<?php
	...
	echo "<div class='showPersonDetails' style='width:600px;'>
			...
			<form action='javascript:add_news();'>
			<table class='form'>
				<tr>
				...
				<tr>
					...
					<td><input type='text' name='m_header' id='m_header' style='width:460px;' onChange=\"document.getElementById('changedContents').value='1';\"></td>
				</tr>
				<tr>
	...
	echo "				</select>
				...
				<tr>
					...
					<td><textarea type='text' name='m_body' id='m_body' style='width:460px; height:200px;' onChange=\"document.getElementById('changedContents').value='1';\"></textarea></td>
				</tr>
				<tr>
